...
-- if the user gets the right answer, play this
local correctSound = audio.loadSound("Sounds/CorrectAnswer.mp3")
local correctSoundChannel

-- if the user gets the wrong answer, play this
...
function scene:create( event )
    ...
    answerTextObject = display.newText("", display.contentWidth*.1, display.contentHeight/2, nil, 50 )
